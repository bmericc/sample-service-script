...
wget -q -O "$SERVICE_FILE" 'https://raw.githubusercontent.com/bmericc/sample-service-script/master/service.sh' || { echo 'ERROR: Could not retreive service.sh from github'; exit 1;}
